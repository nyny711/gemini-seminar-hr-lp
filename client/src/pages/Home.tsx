          ...
          >
            {[
              { 
                ...
                detail: "専門用語や業界知識の知識が不足しており、的確な質問ができるまで時間がかかってしまう。結果として提案までのリードタイムの長期化や品質低下が起こってしまう。" 
              },
              { 
                icon: Users, 
                text: "人材と案件のマッチングが属人的", 
                detail: "ベテランの経験に依存し、新人は適切な候補者を見つけられない。データベースに優秀な人材がいても、見逃してしまう。" 
              },
              { 
                icon: MessageSquare, 
                text: "提案資料・推薦文の作成が手作業", 
                detail: "候補者ごとにスキルシートを見て文章を書き起こし、複数推薦時は作業量が膨大に。過去の成功パターンを活かせず、毎回ゼロから考える非効率が発生している。" 
              },
              { 
                icon: BarChart3, 
                text: "フォロー・進捗管理が後回しになる", 
                detail: "複数案件を抱えると優先順位が曖昧になり、温度感の高い候補者へのフォローが遅れる。結果として他社に先を越されたり、候補者の意欲が低下する事態が頻発する。" 
              },
            ].map((problem, index) => (
